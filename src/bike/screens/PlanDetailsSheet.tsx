...
function PlanDetailsRowPositive({ title, description }: PlanDetailItem) {
  return (
    <li className="plan-details-row">
      ...
      <div className="min-w-0 flex-1 flex flex-col" style={{ gap: "var(--space-1)" }}>
        <Typography variant="body-sm" color="primary" weight="bold" style={{ margin: 0 }}>
          {title}
        </Typography>
        <Typography variant="body-sm" color="secondary" style={{ margin: 0 }}>
          {description}
        </Typography>
      </div>
    </li>
...
export function PlanDetailsSheetContent({ planId }: { planId: PlanId }) {
  ...
  return (
    <div className="bike-sheet-body plan-details-sheet">
      <Typography variant="body-md" color="secondary" style={{ margin: 0 }}>
        {copy.intro}
      </Typography>
...
export function PlanDetailsSheetFooter({ onOkay }: { onOkay: () => void }) {
  return (
